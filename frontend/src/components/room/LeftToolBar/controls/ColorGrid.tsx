...
export default function ColorGrid({ isMostUsedColorsNeeded }: { isMostUsedColorsNeeded: boolean }) {
  return (
    <div className="bg-gray-900 text-white absolute left-[105%] top-3">
      {isMostUsedColorsNeeded &&(<><span>most Used custom colors</span>
      ...
      <span>Hex Code</span>
      <div className="flex">
        <input className="text-white" type="text" name="" placeholder="#tyfd32" id="" />
        <Pipette />
      </div>
