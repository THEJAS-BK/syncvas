  ...
  return (
   <WebRtcProvider roomId={roomId}>
     <div className="h-screen flex flex-col">
      <RoomNavbar floatChatInterface={floatChatInterface} setFloatChatInterface={setFloatChatInterface} setCursorDash={setOpenCursor} cursorDash={openCursor}  />
      <main className="flex-1 flex ">
        {/* cursor interface not open*/}
       {!openCursor&&(
         <MainContent floatChatInterface={floatChatInterface} roomId={roomId} />
       )}
        {openCursor&&(
          <MultiCursor floatChatInterface={floatChatInterface} />
        )}

        <ChatInterface floatChatInterface={floatChatInterface} cursorDash={openCursor} roomId={roomId} /> 
      </main>
    </div>
   </WebRtcProvider>
  );
